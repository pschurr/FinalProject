...
bool loadMedia( Tile* tiles[] )
{
	...
	//Load tile texture
	if( !gTileTexture.loadFromFile( "moresheets_resized.png" ) )
	{
...
/*
			gTileClips[ TILE_LEFT ].x = 32;
			gTileClips[ TILE_LEFT ].y = 32;
			gTileClips[ TILE_LEFT ].w = TILE_WIDTH;
			gTileClips[ TILE_LEFT ].h = TILE_HEIGHT;

			gTileClips[ TILE_BOTTOMLEFT ].x = 32;
			gTileClips[ TILE_BOTTOMLEFT ].y = 64;
			gTileClips[ TILE_BOTTOMLEFT ].w = TILE_WIDTH;
			gTileClips[ TILE_BOTTOMLEFT ].h = TILE_HEIGHT;

			gTileClips[ TILE_TOP ].x = 64;
			gTileClips[ TILE_TOP ].y = 0;
			gTileClips[ TILE_TOP ].w = TILE_WIDTH;
			gTileClips[ TILE_TOP ].h = TILE_HEIGHT;

			gTileClips[ TILE_CENTER ].x = 64;
			gTileClips[ TILE_CENTER ].y = 32;
			gTileClips[ TILE_CENTER ].w = TILE_WIDTH;
			gTileClips[ TILE_CENTER ].h = TILE_HEIGHT;

			gTileClips[ TILE_BOTTOM ].x = 64;
			gTileClips[ TILE_BOTTOM ].y = 64;
			gTileClips[ TILE_BOTTOM ].w = TILE_WIDTH;
			gTileClips[ TILE_BOTTOM ].h = TILE_HEIGHT;

			gTileClips[ TILE_TOPRIGHT ].x = 96;
			gTileClips[ TILE_TOPRIGHT ].y = 0;
			gTileClips[ TILE_TOPRIGHT ].w = TILE_WIDTH;
			gTileClips[ TILE_TOPRIGHT ].h = TILE_HEIGHT;

			gTileClips[ TILE_RIGHT ].x = 96;
			gTileClips[ TILE_RIGHT ].y = 32;
			gTileClips[ TILE_RIGHT ].w = TILE_WIDTH;
			gTileClips[ TILE_RIGHT ].h = TILE_HEIGHT;

			gTileClips[ TILE_BOTTOMRIGHT ].x = 96;
			gTileClips[ TILE_BOTTOMRIGHT ].y = 64;
...
bool touchesWall( SDL_Rect box, Tile* tiles[] )
{
    ...
    for( int i = 0; i < TOTAL_TILES; ++i )
    {
        ...
        if( ( tiles[ i ]->getType() == TILE_WATER) || ( tiles[ i ]->getType() <= TILE_ROCK ) )
        {
	...
	else
	{
		...
		{	
			...
			while( !quit )
			{
				...
				SDL_Rect fillRect = {5,500,180,100};
